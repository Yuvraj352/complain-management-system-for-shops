...
die("Connection Failed: " .mysqli_error());
	...
	$sql=mysqli_query($conn, "SELECT * FROM  shopowner where password='$crpass' && ownerEmail='$email'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($conn, "update shopowner set password='$conpass' where ownerEmail='$email'");
