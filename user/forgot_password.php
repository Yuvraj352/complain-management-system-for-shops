...
$query=mysqli_query($conn,"SELECT * FROM users WHERE userEmail='$email' and contactNo='$contact'");
$query1=mysqli_query($conn,"SELECT * FROM otp_expiry WHERE userEmail='$email' and otp='$ootp'");
$num=mysqli_fetch_array($query);
$num1=mysqli_fetch_array($query1);
if($num>0 && $num1>0)
{
mysqli_query($conn,"update users set password='$password' WHERE userEmail='$email' and contactNo='$contact'");
