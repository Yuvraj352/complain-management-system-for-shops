...
die("Connection Failed: " .mysqli_error());
	...
	$rollno=$_POST['rollno'];
	$query=mysqli_query($conn, "insert ignore into users(fullName,userEmail,password,contactNo,rollno) values('$fullname','$email','$password','$contactno','$rollno')");
		      ...
		      <form class="form-login" method="post" name="register">
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <br>
					<input type="text" class="form-control" maxlength="10" name="rollno" placeholder="Rollno./employee id" required="required" autofocus>
		            <br>
		            ...
		            <div class="registration">
		                ...
		                <a href="http://localhost/cmp/user/login.php">Sign in</a>
		            </div>
                </div>
                </form>
    </div>
