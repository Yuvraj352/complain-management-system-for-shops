...
<html lang="en">
  ...
  <div class="form-group">
    <input type="text" class="form-control" id="NAME" placeholder="NAME" name="txt1">
  </div>
  <div class="form-group">
    <input type="text" class="form-control" id="Roll no." placeholder="ROLL NO./EMPLOYEE ID" name="txt2">
  </div>
  <div class="form-group">
    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="EMAIL" name="email">
  </div>
  <div class="form-group">
    <select class="form-control" id="SHOP NO." name="select" >
...
?>
  ...
  <div class="form-group">
    <textarea class="form-control" id="complaint" name="text3" rows="2" placeholder= "WRITE YOUR COMPLAIN HERE.... "></textarea>
  </div>
  <div>
    <p align="left">want to remain anonymous?
  <select class="form-control" name="opt" style="width:75px;">
  <option value="0" default>NO</option>
  <option value="1">YES</option>
    </p></div>
  <div class="form-group" >
  <input class="btn btn-secondary" type="submit" value="Register" name ="submit" align="center">
  </div>
  <hr>
	 <div>
...
$sql="insert into complain(name,rollno,email,selection,complains,time,opt) values('$a','$b','$c','$d','$e','" .date("Y-m-d H:i:s",). "','$f')";
...
{
  echo" recor insred successfully";
