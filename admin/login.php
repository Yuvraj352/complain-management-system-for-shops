...
$ret=mysqli_query($conn, "SELECT * FROM admin WHERE adminEmail='".$_POST['username']."' and password='".md5($_POST['password'])."'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
	$_SESSION['login']=$_POST['username'];
	$_SESSION['CREATED'] = time();
header("location:http://localhost/cmp/admin/admin_index.php");
exit();
}
else
{
		        ...
		        <div class="login-wrap cont-1">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a href="http://localhost/cmp/admin/verification.php"> Forgot Password?</a>
		                </span>
		            </label>
