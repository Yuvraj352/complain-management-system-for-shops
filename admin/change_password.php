...
die("Connection Failed: " .mysqli_error());
	...
	$sql=mysqli_query($conn, "SELECT password FROM  admin where password='$crpass' && adminEmail='$email'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($conn, "update admin set password='$conpass' where adminEmail='$email'");
